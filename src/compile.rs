  ...
  pub fn output(&self) -> PathBuf {
    self.output.clone().unwrap_or_else(|| {
      self
        .common
        .input
        .with_extension(match self.output_format().unwrap_or(OutputFormat::Pdf) {
...
fn export(
  ...
  match command.output_format()? {
    OutputFormat::Png => export_image(world, document, command, watching, ImageExportFormat::Png),
    OutputFormat::Svg => export_image(world, document, command, watching, ImageExportFormat::Svg),
